...
LifePilot is a native SwiftUI iOS/macOS app (Swift package, see `Package.swift`). The
Cursor Cloud VM is **Linux**, so only part of the project can build/run here. Read this
